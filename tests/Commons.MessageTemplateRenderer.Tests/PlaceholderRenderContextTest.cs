...
namespace Queo.Commons.MessageTemplateRenderer.Tests {
    ...
    public class PlaceholderRenderContextTest {
        ...
        private ILogger<PlaceholderRenderContext> _logger;

        /// <summary>
        ///     Testet das Ersetzen in einem Template, bei dem ein Platzhalter auf ein Child-Property eines Child-Propery eines
        ...
        /// <summary>
        ///     Testet das formatieren des Templates, wenn der Pfad im Model nicht gefunden wird und in diesem Fall ein beliebiger
        ...
        public void TestRenderTemplate() {
            ...
            ITemplate parsedTemplate = new PlaceholderRenderContext(_logger).Parse(TEMPLATE);
