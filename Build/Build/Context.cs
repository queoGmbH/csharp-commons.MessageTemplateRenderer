...
namespace Build
{
    public class Context : FrostingContext
    {
        ...
        public IList<Lib> Lib { get; } = new List<Lib>() {
            new Lib() { BuildConfig = "Release", MainProject = @"src\Commons.MessageTemplateRenderer\Commons.MessageTemplateRenderer.csproj" }
        };
    ...
    public class General
    {
        ...
        public string Name { get; } = "Commons.MessageTemplateRenderer";

        public string SolutionName { get; } = "Commons.MessageTemplateRenderer.sln";
    }
    ...
    public class Tests
    {
        public Dictionary<string, string> TestProjects { get; } = new Dictionary<string, string>() {
            { "Commons.Tests", @"tests\Commons.MessageTemplateRenderer.Tests\Commons.MessageTemplateRenderer.Tests.csproj" }
        };
